...
public class S_MCTS_Explore_AI extends MonteCarloTreeSearchPlayer {
	...
	public S_MCTS_Explore_AI(String name, String opp, String map, int id, long time) {
		super(name, opp, map, id, time, new AIParameter(Double.NEGATIVE_INFINITY, 20));
	}
	...
	protected MCTSNode Expand(MCTSNode lastNode) {
		...
		case MANOEUVRE: {
			...
			if (lastNode.manChildren == null) {
				...
				noManChild.setTreePhase(NodeType.RECRUIT);
