 ...
 *
 */
public class MCTSHashing_Uniqueness_AI extends MCTSMove_After_Attack_AI {

	public static void main(String[] args) {
		String tempName = args[0];
		long time = Long.parseLong(args[1]);
		new MCTSHashing_Uniqueness_AI(tempName, null, null, 2, time);
	}

	public MCTSHashing_Uniqueness_AI(String name, String opp, String map, int id,
			long time) {
