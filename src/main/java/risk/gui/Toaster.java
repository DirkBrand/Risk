...
public class Toaster 
{
  ...
  // Set message color
	 ...
	 * 
	 */
	public Toaster(JFrame parent, int delayTime)
	{
		this.displayTime = delayTime;
		this.parent = parent;
		
		// Set default font...
		font = new Font("Arial", Font.BOLD, 12);
		// Border color
		borderColor = new Color(66, 152, 245);
	...
	class Animation extends Thread
	{
		...
		public void run()
		{
			try
			{
				...
				int posx = screenRect.x + (int) screenRect.width/2 - toasterWidth + 100;
				...
				{
					startYPosition = screenRect.y + screenHeight - toasterHeight;
					stopYPosition = startYPosition - toasterHeight - 200;
    ...
    singleToaster.message.setText("<html><body align=center>" +  msg );
