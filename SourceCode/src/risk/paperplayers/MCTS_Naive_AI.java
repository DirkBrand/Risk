...
public class MCTS_Naive_AI extends MonteCarloTreeSearchPlayer {
	...
	public static void main(String[] args) {
		...
		new MCTS_Naive_AI(tempName, null, null, 2, time);
	}

	public MCTS_Naive_AI(String name, String opp, String map,
			int id, long time) {
